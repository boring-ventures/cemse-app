...
export default function PrivateLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Tabs.Screen
        name="entrepreneurship/directory/index"
        options={{
          headerShown: false,
          href: null,
          tabBarStyle: { display: "none" },
      ...
      />
      <Tabs.Screen
        name="entrepreneurship/directory/[id]"
        options={{
          headerShown: false,
          href: null,
          tabBarStyle: { display: "none" },
      ...
      />
      <Tabs.Screen
        name="entrepreneurship/directory/[id]/posts/[postId]"
        options={{
          headerShown: false,
          href: null,
          tabBarStyle: { display: "none" },
      ...
      />
      <Tabs.Screen
        name="entrepreneurship/messaging/index"
        options={{
          headerShown: false,
          href: null,
          tabBarStyle: { display: "none" },
      ...
      />
      <Tabs.Screen
        name="entrepreneurship/messaging/[contactId]"
        options={{
          headerShown: false,
          href: null,
          tabBarStyle: { display: "none" },
      ...
      />
      <Tabs.Screen
        name="entrepreneurship/resources/index"
        options={{
          headerShown: false,
          href: null,
          tabBarStyle: { display: "none" },
      ...
      />
      <Tabs.Screen
        name="entrepreneurship/resources/[id]"
        options={{
          headerShown: false,
          href: null,
          tabBarStyle: { display: "none" },
